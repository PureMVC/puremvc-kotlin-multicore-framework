...
import org.puremvc.kotlin.multicore.interfaces.IModel
...
open class Model(key: String): IModel {
    ...
    companion object {
         ...
         */
        @Synchronized fun getInstance(key: String, factory: (key: String) -> IModel): IModel {
         ...
         */
        @Synchronized fun removeModel(key: String) {
